...
public class FileSys {
    ...
    public void openFile() {
        ...
        {
            JOptionPane.showMessageDialog(filechooser,"Filename","Please enter file name",JOptionPane.ERROR_MESSAGE);
        }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(drawpad,"Source not found","not found",JOptionPane.ERROR_MESSAGE);
            } catch (IOException e) {
                JOptionPane.showMessageDialog(drawpad,"load error","load error",JOptionPane.ERROR_MESSAGE);
            } catch (ClassNotFoundException e) {
                JOptionPane.showMessageDialog(drawpad,"fail to build","EOF",JOptionPane.ERROR_MESSAGE);
            }
    ...
    public void saveFile() {
        ...
        if(fileName == null || fileName.getName().equals(""))//文件名不存在时
        {
            JOptionPane.showMessageDialog(filechooser,"Filename","Enter file name",JOptionPane.ERROR_MESSAGE);
        }
        else {
            try {
                fileName.delete();//删除此抽象路径名表示的文件或目录
                FileOutputStream fos = new FileOutputStream(fileName+".stream");//文件输出流以字节的方式输出
                //对象输出流
